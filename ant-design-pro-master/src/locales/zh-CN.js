export default {
  ...
  'form.title.id': '上报人ID',
  'form.title.name': '上报人姓名',
  'form.title.id.placeholder': '请输入上报人ID',
  'form.title.name.placeholder': '请输入上报人姓名',
  'form.date.label': '上报时间',
  'form.content.label': '上报内容',
  'form.content.placeholder': '请输入上报内容',
  'form.emergency.label': '紧急级别',
  'form.emergency.placeholder': '请选择紧急级别',
  'form.public.label': '日志公开',
  ...
  'menu.dailylog': '日志上报',
  'menu.dailylog.dailylogsubmit': '每日日志上报',
  'app.dailylog.dailylogsubmit.title': '每日日志上报',
  'dailylog.dailylogsubmit.id': '上报者ID',
  'dailylog.dailylogsubmit.id.placeholder': '请输入上报者ID',
  'dailylog.dailylogsubmit.name': '上报者姓名',
  'dailylog.dailylogsubmit.name.placeholder': '请输入上报者姓名',
  'dailylog.dailylogsubmit.time': '上报时间',
  'dailylog.dailylogsubmit.content': '上报内容',
  'dailylog.dailylogsubmit.content.placeholder': '字数限制在300字以内',
  'dailylog.dailylogsubmit.emergency': '日志紧急级别',
  'dailylog.dailylogsubmit.open': '日志是否公开',
  'dailylog.dailylogsubmit.sorry': '抱歉，此为必填选项',
  'dailylog.dailylogsubmit.open.open': '公开',
  'dailylog.dailylogsubmit.open.privacy': '私密',
  'dailylog.dailylogsubmit.button.submit': '提交',
  'dailylog.dailylogsubmit.button.reset': '重置',
  'menu.dailylog.emergencysubmit': '紧急日志上报',
  'menu.dailylog.emergencysubmit.info': '填写上报信息',
  'menu.dailylog.emergencysubmit.confirm': '确认上报信息',
  'menu.dailylog.emergencysubmit.result': '结果',


  'menu.usermanagement': '用户管理',
  'menu.usermanagement.userchart': '用户图表信息',
  'usermanagement.usernumber_allday': '今日用户登录总数',
  'usermanagement.usernumber_isactivity': '当前在线用户总数',
  'usermanagement.usernumber_month_activity': '当月活跃用户数',
  'usermanagement.usernumber_all': '总注册用户数',
  'usermanagement.info_all': '收到总数据量',
  'usermanagement.info_day': '今日收到数据量',
  'usermanagemnt.info.year.trend': '当年每月数据量变化趋势',
  'usermanagement.info.year.trend.1': '数据量',
  'usermanagement.info.day.trend.1': '数据量',
  'usermanagement.info.day.trend': '今日数据量变化趋势',

  'account.setting.email': '修改邮箱',
  'account.setting.name': '修改昵称',
  'account.setting.country': '国家/地区',
  'account.setting.geographic': '所在省市',
  'account.setting.phone': '修改联系方式',
  'account.setting.button': '提交修改',
  'account.settings.avatar': '头像',
  'account.settings.change-avatar': '更换头像',
  'account.settings.menuMap.myself': '个人信息',
  'account.settings.menuMap.modify': '修改资料',
  'menu.account': '个人中心',
  'menu.account.settings': '查看修改',
  'menu.permission': '权限管理',
  'menu.permission.tablelist': '账户权限管理',
  'menu.data': '数据管理',
  'menu.data.tablelist': '数据查阅',
  'menu.account.center': '个人中心',


  'menu.form': '日志模块',
  'menu.form.basicform': '每日日志上报',
